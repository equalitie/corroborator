...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'corroborator_app_userlog')

        # Deleting field 'VersionStatus.user'
        db.delete_column(u'corroborator_app_versionstatus', 'user_id')

        # Deleting field 'VersionStatus.version_timestamp'
        db.delete_column(u'corroborator_app_versionstatus', 'version_timestamp')
