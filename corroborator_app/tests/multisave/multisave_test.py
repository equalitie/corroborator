...
from corroborator_app.multisave import multi_save_actors, extract_actor_ids, \
    update_actors, process_actor_data
...
class MultiSaveActorTestCase(TestCase):
    ...
    def test_actor_update_from_query_dict(self):
        ...
        update_actors(json_dict, actor_objects)
