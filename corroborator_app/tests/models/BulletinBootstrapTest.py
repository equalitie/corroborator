...
class BulletinBootstrapTestCase(TestCase):
    ...
    def test_actor_formatted(self):
        ...
        test_bulletin = {
            ...
            'count_actors': 2, 
            u'sources': ['/api/v1/source/1/', '/api/v1/source/7/', '/api/v1/source/9/'], 
            ...
            u'deleted': False, 
            u'title_en': u'IRX.A0001.648.001', 
            u'description_en': u'', 
            ...
            u'medias': ['/api/v1/media/2/', '/api/v1/media/169/', '/api/v1/media/180/'], 
            u'bulletin_comments': ['/api/v1/comment/5/'], 
            'ref_incidents': ['/api/v1/incident/1/', '/api/v1/incident/2/', 
