...
$('#bulletin-status-filter, #bulletin-assigned-filter').on('click', '.zbulletin-option', function(){
...
$('#incident-status-filter, #incident-assigned-filter, #incident-crime-filter').on('click', '.bulletin-option', function(){
