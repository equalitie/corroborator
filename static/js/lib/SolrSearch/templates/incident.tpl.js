...
return templates['incident.tpl'] = template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  var buffer = "", stack1, stack2, functionType="function", escapeExpression=this.escapeExpression;


  buffer += "<tr count=\"20\" class=\"REPEAT Incident in-table\">\n  <td class=\"is-selector\">\n    <input type=\"checkbox\" "
  ...
  buffer += escapeExpression(stack2)
    ...
    + escapeExpression(((stack1 = ((stack1 = depth0.model),stack1 == null || stack1 === false ? stack1 : stack1.incident_created)),typeof stack1 === functionType ? stack1.apply(depth0) : stack1))
