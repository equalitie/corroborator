...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  if (stack1 = helpers.navValue) { stack1 = stack1.call(depth0, {hash:{},data:data}); }
  else { stack1 = depth0.navValue; stack1 = typeof stack1 === functionType ? stack1.apply(depth0) : stack1; }
  buffer += escapeExpression(stack1)
    + " sort-status\">status</a>\n</th>\n<th class=\"is-score sort-header\">\n  <a href=\"#\" class=\"T ";
  if (stack1 = helpers.navValue) { stack1 = stack1.call(depth0, {hash:{},data:data}); }
  else { stack1 = depth0.navValue; stack1 = typeof stack1 === functionType ? stack1.apply(depth0) : stack1; }
  buffer += escapeExpression(stack1)
    + " sort-score\">score</a>\n</th>\n\n";
