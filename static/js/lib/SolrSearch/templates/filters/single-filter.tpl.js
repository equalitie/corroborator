...
function program3(depth0,data) {
  ...
  buffer += "<span class=\"text T\" data-key=\""
    ...
    + "\">\n  ";
  stack2 = helpers['if'].call(depth0, ((stack1 = depth0.model),stack1 == null || stack1 === false ? stack1 : stack1.name_en), {hash:{},inverse:self.program(3, program3, data),fn:self.program(1, program1, data),data:data});
