...
<form id="incident_form" onsubmit="return false;">
<div class="Incident in-preview is-edited">
      <div class="Incident is-edited">
              <div class="col first span-66p hidden incident-expanded-edit">
                ...
                <div id="incident-body-expand" class="body">
  ...
  <label>Title
    ...
    <div lang="en">
    <textarea id="incident_title_en" type="text" class="validate[required] w-100p"></textarea></div>
    <div lang="ar">
    <textarea type="text" id="incident_title_ar" class="w-100p"></textarea></div>
    <span class="toggle"><span lang="en">EN</span><span lang="ar">AR</span></span></span></label></h2>
  </div>
  <div id="incident-group-block-ne" class="body incident-not-expanded-edit">
    <div id="incident-group-block" class="group details">
      <div class="field clear-after">
        ...
        <div id="incident-assignment-block" class="is-assigned-to left">
          <label>Assigned to</label>
    <br>
  
    <input type="text" id="user-ac-incident_6" style="margin-right: -1.5em;" class="validate[required] with-clear is-assigned ui-autocomplete-input" value="cormac" autocomplete="off"><span role="status" aria-live="polite" class="ui-helper-hidden-accessible"></span> 
...
<div class="clearer">&nbsp;</div>
    <div id="incident-label-block" class="field is-tags">
      ...
      <ul class="tags editor">
        ...
        <li class="tag is-new">
          <input type="text" value="Label" class="with-select labels-ac ui-autocomplete-input" autocomplete="off"><span role="status" aria-live="polite" class="ui-helper-hidden-accessible"></span>
        </li>
      </ul>
    </div>
    ...
    <div id="incident-crime-block" class="field is-crimes">
      ...
      <ul class="crimes editor">
        ...
        <li class="crime is-new">
          <input type="text" value="Crime" class="with-select crimes-ac ui-autocomplete-input" autocomplete="off"><span role="status" aria-live="polite" class="ui-helper-hidden-accessible"></span>
        </li>
      </ul>
    </div>
      </div>
