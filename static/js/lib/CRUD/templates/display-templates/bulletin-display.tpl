<div class="Bulletin in-view">
  <div class="header">
    <span class="id">
      ID <span class="value out">1452113364</span>
    </span>
    <h2 class="title">
      <span class="i18n with-en with-ar">
        <span lang="en">A bulletin about this crime with a long title</span>
    ...
    <div class="group details">
      ...
      <div class="date-location">
        <span class="date">2012/Mar/23—2012/Mar/30</span>, in <span class="location">Damas, Syriah</span>
      </div>
      <div class="sources">
  ...
  <div class="body">
    ...
    <div class="description">Lorem ipsum dolor sit amet, consectetur adipiscing elit.  Curabitur congue enim sed lacus congue id feugiat nisl vestibulum. Sed suscipit ipsum vel diam consequat interdum.  Donec pulvinar lorem non metus viverra tristique. Integer sollicitudin, urna quis commodo commodo, nibh elit condime.</div>
